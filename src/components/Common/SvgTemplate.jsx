...
const SvgTemplate = (props) => {
    switch (props.id) {
            ...
            return (
                <span className="icon">
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path d="M0 1.55798H24.0199" stroke="" strokeWidth="2" />
                        <path d="M0 10.0503L24.0198 10.0503" stroke="" strokeWidth="2" />
                    </svg>
                </span>
            );
        case "search":
        ...
        case "telegram":
            return (
                <span className="icon">
                    <svg className="icon__telegram" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        case "instagram":
            return (
                <span className="icon">
                    <svg className="icon__instagram" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
